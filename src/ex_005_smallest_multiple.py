...
- Start by multiplying all the primes in the interval together. What ever the answer is,
it will be a multiple of that.
- Since we go from low to high, then for a non-prime number x the result will either
already be divisable by x,
...
def calculate_new_multiple(a_num, res):
    """ helper function to calculate if a new multiple is needed"""
